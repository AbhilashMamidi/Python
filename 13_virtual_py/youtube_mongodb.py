...
client = MongoClient("mongodb+srv://Youtubepy:Youtubepy@cluster0.lcumh.mongodb.net/", tlsAllowInvalidCertificates = True)
...
def delete_video(video_id):
    ...
    #TODO: debug this video id problem
...
def main():
    while True:
        ...
        if choice == '1':
            ...
            video_id = input("Enter the video id to upadte: ")
